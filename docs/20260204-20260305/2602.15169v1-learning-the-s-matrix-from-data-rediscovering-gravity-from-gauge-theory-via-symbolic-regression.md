...
tags: ["query:sr"]
score: 10.0
evidence: 通过符号回归重新发现引力和规范场论关系
tldr: 本研究展示了利用机器学习从数值数据中自动重构散射振幅解析结构的能力。通过符号回归技术，研究者成功从杨-米尔斯振幅中重新发现了将引力与规范场论联系起来的KLT关系。利用QR分解等特征选择技术，在无群论先验的情况下识别出了KK和BCJ关系。该方法在五点树级振幅上达到了极高精度，证明了数据驱动方法在探索物理理论隐藏关系方面的巨大潜力。
selection_source: fresh_fetch
motivation: 探索现代机器学习方法是否能仅凭数值数据自主发现散射振幅中复杂的解析结构和物理定律。
method: 采用符号回归结合列主元QR分解特征选择技术，以曼德尔施塔姆不变量为输入处理色有序振幅。
result: 成功重新发现了KLT、KK和BCJ关系，并在五点外部腿的情况下实现了高精度的数值重构。
conclusion: 符号回归是探索散射振幅解析结构的实用工具，为揭示一般物理理论中的隐藏关系提供了通用的数据驱动策略。
---
